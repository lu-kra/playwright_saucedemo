...
- Name: login.spec.ts >> Login Tests >> Cannot login with valid username and invalid password
- Location: tests\login.spec.ts:25:9

# Error details

```
Error: Invalid credential error message is not visible
...
Call log:
  - Invalid credential error message is not visible with timeout 5000ms
