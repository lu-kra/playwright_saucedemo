...
```
Error: A snapshot doesn't exist at C:\Users\lukyk\playwright_saucedemo\tests\visual.spec.ts-snapshots\Visual-testing-Visual-test---login-page-1-iPhone-win32.png, writing actual.
```
