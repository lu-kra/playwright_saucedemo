...
- Name: api.spec.ts >> API Tests >> Block request @api
- Location: tests\api.spec.ts:163:10
...
```ts
  ...
  161 | 
  162 | 
  163 |     test.only('Block request @api', async ({ page, context }) => {
  164 | 
  165 |         await context.route(/\.(jpg|png)$/, route => route.abort());
> 166 |         await page.goto('/');
      |                    ^ Error: page.goto: Target page, context or browser has been closed
